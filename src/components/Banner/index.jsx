...
export default function Banner() {
  return (
    <div
      ...
      "
    >
      <section className=" flex justify-center  xl:flex xl:flex-row flex-col items-center w-full ">
        <div className="relative z-10 flex gap-1 flex-col items-center pt-4 xs:w-[76%] sm:w-[630px] md:w-[90%] lg:w-[80%] xl:w-[450px]  ">
        ...
        <div className="sm:w-[600px] lg:w-[800px]  sm:p-2 p-2 xs:p-4 flex flex-col xs:flex-row  ">
          <img
            src="/marmitaFeita.png"
            alt="Restaurante"
            className="relative z-10 w-[300px] xs:w-[270px] sm:w-[360px] lg:w-[400px] lg:h-[260px] xl:w-[560px] 2xl:w-[650px] 2xl:h-[340px] "
          />
          <div className="lg:w-[500px]  relative z-10 flex xs:flex-col lg:flex-col  xl:flex-col items-center justify-center gap-10 xs:gap-4 lg:gap-3 ">
      ...
      <img
        className="absolute w-full left-0  object-cover bottom-0 h-full opacity-30 "
